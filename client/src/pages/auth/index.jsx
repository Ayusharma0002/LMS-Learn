              ...
              function AuthPage() {
                ...
                function checkIfSignUpFormIsValid() {
                  if (
                    ...
                    const passwordValidation = signUpFormControls.find(
                      (control) => control.name === "password"
                    ).validation;
              
                    const error = passwordValidation(signUpFormData.password);
                    return !error;
                  }
                  return false;
                }
                ...
                return (
                  <div className="flex flex-col min-h-screen">
                    <header className="px-4 lg:px-6 h-14 flex items-center border-b">
                      <Link to={"/"} className="flex items-center justify-center">
                        <img
                          className="font-extrabold text-xl h-10 w-full"
                          src="/logo.png"
                        ></img>
                      </Link>
                    </header>
                            ...
                            {/* <CardContent className="space-y-2">
                              ...
                              {signUpFormData.password && (
                                <p className="text-sm text-red-500">
                                  {
                                    signUpFormControls.find(
                                      (control) => control.name === "password"
                                    ).validation(signUpFormData.password)
                                  }
                                </p>
                              )}
                            </CardContent> */}
                            <CardContent className="space-y-2 max-h-[80vh] overflow-y-auto">
      <CommonForm
        formControls={signUpFormControls}
        buttonText={"Sign Up"}
        formData={signUpFormData}
